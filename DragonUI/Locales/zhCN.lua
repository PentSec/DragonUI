...
L["World Map"] = "世界地图"
L["Modern frame, portrait and breadcrumb navigation on the world map, with the quest log as a side panel."] = "带有现代边框、肖像和面包屑导航的世界地图，任务日志作为侧面板。"
L["Drag to resize"] = "拖动以调整大小。"
L["Right-click to reset the size."] = "右键点击重置大小。"
